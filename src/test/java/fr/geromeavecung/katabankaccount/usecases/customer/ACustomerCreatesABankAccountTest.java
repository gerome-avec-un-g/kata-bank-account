...
import fr.geromeavecung.katabankaccount.usecases.customer.createsaccount.AccountCreationRequest;
import fr.geromeavecung.katabankaccount.usecases.customer.createsaccount.ACustomerCreatesABankAccount;
...
class ACustomerCreatesABankAccountTest {

    private AccountsInMemory accountsInMemory;

    private ACustomerCreatesABankAccount aCustomerCreatesABankAccount;
    ...
    void setup() {
        ...
        aCustomerCreatesABankAccount = new ACustomerCreatesABankAccount(new CreateAccount(accountsInMemory, fixedTimestamps));
    ...
    void given_a_connected_user_when_he_create_an_account_without_a_first_deposit_then_the_account_is_created_without_operations() {
        ...
        aCustomerCreatesABankAccount.execute(user, accountCreationRequest);
    ...
    void given_a_connected_user_when_he_create_an_account_with_a_first_deposit_of_negative_1_euros_then_he_obtains_an_error() {
        ...
        assertThatThrownBy(() -> aCustomerCreatesABankAccount.execute(user, accountCreationRequest))
    ...
    void given_a_connected_user_with_no_account_and_an_account_for_another_user_when_he_create_an_account_without_a_first_deposit_then_the_account_is_created_without_operations() {
        ...
        aCustomerCreatesABankAccount.execute(connectedUser, accountCreationRequest);
